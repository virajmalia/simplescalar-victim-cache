...
def run_miss_cache_16():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_mc16.out'		#change 3 with benchmark of choice, dc-->Default Cache
	config = ' -cache:dmcache dmcache:16:l -cache:imcache imcache:16:l'
	...
	asm_out = 'OUTmc16'				#change 3 with benchmark of choice, dc-->Default Cache
	...
	print ('Running ' + bm + 'for 16 entry Miss Cache config')
	os.system(run_cmd)
