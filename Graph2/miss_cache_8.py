...
def run_miss_cache_8():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_mc8.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	asm_out = 'OUTmc8'				#change 3 with benchmark of choice, dc-->Default Cache
	...
	print ('Running ' + bm + 'for 8 entry Miss Cache config')
	os.system(run_cmd)
