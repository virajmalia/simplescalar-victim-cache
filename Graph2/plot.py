...
def plotData():
	...
	title = []
	sim_type = []
	with open('/home/viraj/Documents/Graph2/data.out', 'r') as f:
		for num, line in enumerate(f,0):
			...
			if (sim == 'sim_dc1.out'):
				...
				for i in range(1,5):
					dc_value.append(int(val))
			if (sim == 'sim_mc1.out' or sim == 'sim_mc2.out' or sim == 'sim_mc4.out' or sim == 'sim_mc8.out' or sim == 'sim_mc16.out'):
	...
	ax.set_title('Reduction in number of ul2 accesses Miss Cache ' + str(dc_value[0]))
