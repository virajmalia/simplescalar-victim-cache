...
def run_vic_cache_16():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_vc16.out'		#change 3 with benchmark of choice, dc-->Default Cache
	config = ' -cache:dvcache dvcache:16:l -cache:ivcache ivcache:16:l'	
	...
	asm_out = 'OUTvc16'				#change 3 with benchmark of choice, dc-->Default Cache
	...
	print ('Running ' + bm + 'for 16 entry Victim Cache config')
	os.system(run_cmd)
