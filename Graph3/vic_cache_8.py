...
def run_vic_cache_8():
	...
	sim_file = 'results/sim_vc8.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	asm_out = 'OUTvc8'				#change 3 with benchmark of choice, dc-->Default Cache
	...
	print ('Running ' + bm + 'for 8 entry Victim Cache config')
	os.system(run_cmd)
