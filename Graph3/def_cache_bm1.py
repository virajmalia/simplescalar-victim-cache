...
def run_def_cache_bm1():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_dc1.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	asm_out = 'OUTdc1'				#change 3 with benchmark of choice, dc-->Default Cache
