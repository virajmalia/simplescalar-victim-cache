...
def run_vic_cache_bm1():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_vc1.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	asm_out = 'OUTvc1'				#change 3 with benchmark of choice, dc-->Default Cache
