...
def run_def_cache_bm4():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_dc4.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	asm_out = 'OUTdc4'				#change 3 with benchmark of choice, dc-->Default Cache
