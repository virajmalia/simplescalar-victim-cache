...
def run_vic_cache_bm5():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_vc5.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	asm_out = 'OUTvc5'				#change 3 with benchmark of choice, dc-->Default Cache
