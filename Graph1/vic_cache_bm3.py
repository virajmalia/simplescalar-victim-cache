...
def run_vic_cache_bm3():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_vc3.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	bm = '3.alpha '					#change 3 with benchmark of choice
	bm_in = '</home/viraj/Documents/SimpleScalar/simplesim-alpha/benchmarks/1stmt.i>'
	asm_out = 'OUTvc3'				#change 3 with benchmark of choice, dc-->Default Cache
