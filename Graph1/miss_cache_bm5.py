...
def run_miss_cache_bm5():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_mc5.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	asm_out = 'OUTmc5'				#change 3 with benchmark of choice, dc-->Default Cache
