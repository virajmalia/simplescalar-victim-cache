...
def run_miss_cache_bm2():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_mc2.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	asm_out = 'OUTmc2'				#change 3 with benchmark of choice, dc-->Default Cache
