...
def run_miss_cache_bm3():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_mc3.out'		#change 3 with benchmark of choice, dc-->Default Cache
	config = ' -cache:dmcache dmcache:8:l -cache:imcache imcache:8:l'
	...
	asm_out = 'OUTmc3'				#change 3 with benchmark of choice, dc-->Default Cache
	...
	print ('Running ' + bm + 'for Miss Cache config')
	os.system(run_cmd)
