...
def run_vic_cache_bm2():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_vc2.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	bm = '2.alpha '					#change 3 with benchmark of choice
	bm_in = '</home/viraj/Documents/SimpleScalar/simplesim-alpha/benchmarks/1stmt.i>'
	asm_out = 'OUTvc2'				#change 3 with benchmark of choice, dc-->Default Cache
