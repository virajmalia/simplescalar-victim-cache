...
def run_miss_cache_bm4():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_mc4.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	asm_out = 'OUTmc4'				#change 3 with benchmark of choice, dc-->Default Cache
