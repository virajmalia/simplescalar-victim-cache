...
def run_def_cache_bm2():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_dc2.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	asm_out = 'OUTdc2'				#change 3 with benchmark of choice, dc-->Default Cache
