...
def run_def_cache_bm3():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_dc3.out'		#change 3 with benchmark of choice, dc-->Default Cache
	...
	asm_out = 'OUTdc3'				#change 3 with benchmark of choice, dc-->Default Cache
