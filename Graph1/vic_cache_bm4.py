...
def run_vic_cache_bm4():
	cmd = './sim-cache -redir:sim '
	sim_file = 'results/sim_vc4.out'		#change 3 with benchmark of choice, dc-->Default Cache
	config = ' -cache:dvcache dvcache:8:l -cache:ivcache ivcache:8:l'	
	bm_dir = ' /home/viraj/Documents/SimpleScalar/simplesim-alpha/benchmarks/'
	bm = '4.alpha '					#change 3 with benchmark of choice
	bm_in = '</home/viraj/Documents/SimpleScalar/simplesim-alpha/benchmarks/1stmt.i>'
	asm_out = 'OUTvc4'				#change 3 with benchmark of choice, dc-->Default Cache
	...
	print ('Running ' + bm + 'for Victim Cache config')
	os.system(run_cmd)
